...
"""
def sim_gonogo(learner_env, adv_model, output_path, stochastic=False):
    with LogFile(output_path, 'run.log'):
        ...
        learner_env.reset()
        adv_state, _, _, _ = learner_env.step_adv(0)
        #
        # cc = []
        ...
        for t in range(350):
            ...
            rnn_actions.append(learner_info['learner_action'][np.newaxis])
