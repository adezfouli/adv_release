...
def run_adv(i):
    ...
    learner_model_path = '../models/archive/learner/rmrtt/mrtt_RND_learner_single/cells_3/model-700.h5'

    output_path =  '/scratch1/dez004/RL_rmrtt_dqn_RND_' + str(mode) +  '/RL_nc_dqn_buf_' + str(buf)+ '_eps_' + str(eps) + '_lr_' + str(lr) + '/'
