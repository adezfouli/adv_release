...
base_dirs = '/scratch1/dez004/RL_human_dqn_vec/'
dirs = [[o, os.path.join(base_dirs, o)] for o in os.listdir(base_dirs) if os.path.isdir(os.path.join(base_dirs, o))]

dirs_iter = []
for d in dirs:
    for i in [1400000, 1300000, 1200000, 1000000, 900000, 800000, 700000, 600000, 500000, 400000, 300000, 200000, 100000]:
        dd = d.copy()
        dd.append(str(i))
        dirs_iter.append(dd)
...
def run_sim(i):
    try:
        ...
        output_path = '/scratch1/dez004/RL_human_dqn_vec_sim/nc_sim_' + dirs_iter[i][2] + '/' + dirs_iter[i][0] + '/'
