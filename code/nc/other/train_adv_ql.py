...
def run_adv(i):
    ...
    learner_model_path = '../models/archive/learner/nc/learner_ql_nc_cells_4/model-19800.h5'
    adv_model_path = None

    output_path = '../nongit/temp/scratch1/dez004/RL_nc_ql/RL_nc_' + str(layers) + 'layers_' + str(eps) + 'ent_' + str(
        units) + 'units/'
