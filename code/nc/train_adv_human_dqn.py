...
def run_adv(i):
    ...
    learner_model_path = '../models/archive/learner/nc/nc_human_learner_single/cells_10/model-1100.h5'

    output_path =  '/scratch1/dez004/RL_human_dqn_vec/RL_nc_dqn_buf_' + str(buf)+ '_eps_' + str(eps) + '_lr_' + str(lr) + '/'
